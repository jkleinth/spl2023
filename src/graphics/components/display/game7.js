...
export function Game7() {
    ...
    return (
        <div style={{display:"flex", flexDirection:"column"}}>
             <div style={{ display: "flex", justifyContent: "space-evenly" , marginTop:"300px"}}>
            ...
            <div style={{ marginBottom: "40px", marginTop:"100px", display: "flex", justifyContent: "center", alignItems: "end"  }}>
                {liveList}
            </div>
        </div>
    );
