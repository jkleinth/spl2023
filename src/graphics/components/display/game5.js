...
export function Game5() {
    ...
    var list9 = [
        ...
        <img key="6" src={'./game5/1/6.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="5" src={'./game5/1/5.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="2" src={'./game5/1/2.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="4" src={'./game5/1/4.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="1" src={'./game5/1/1.png'} style={{ width: "100%", marginTop: "10px" }} />
    ]

    var list2 = [
        <img key="1" src={'./game5/2/1.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="3" src={'./game5/2/3.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="2" src={'./game5/2/2.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="6" src={'./game5/2/6.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="4" src={'./game5/2/4.png'} style={{ width: "100%", marginTop: "10px" }} />
    ]


    var list3 = [
        <img key="5" src={'./game5/3/5.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="1" src={'./game5/3/1.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="3" src={'./game5/3/3.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="2" src={'./game5/3/2.png'} style={{ width: "100%", marginTop: "10px" }} />,
        <img key="6" src={'./game5/3/6.png'} style={{ width: "100%", marginTop: "10px" }} />
    ]
        ...
        NCGStore.on("change", () => {
            ...
            if (replicants.questionCounter == 1) {
                ...
                if (setStartList == false) {
                    setLiveList([
                        <img key="3" src={'./game5/1/3.png'} style={{ width: "100%", marginTop: "10px" }} />
                    ])
                ...
                if (setStartList == false) {
                    console.log("set2")
                    setLiveList([
                        <img key="5" src={'./game5/2/5.png'} style={{ width: "100%", marginTop: "10px" }} />
                    ])
                    // setLiveList(oldArray => [...oldArray].sort((a, b) => a.key - b.key))
                    setStartList = true
                }
                ...
                if (setStartList == false) {
                    console.log("set3")
                    setLiveList([
                        <img key="4" src={'./game5/3/4.png'} style={{ width: "150%", marginTop: "10px" }} />
                    ])
            ...
            if (replicants.questionCounter > 0) {
                switch (replicants.livesOrdnungStud) {
                    case 0: setStudLive([
                        <img key="1" src={'./game5/studLive.png'} style={{ width: "76px", marginTop: "5px" }} />,
                        <img key="2" src={'./game5/studLive.png'} style={{ width: "76px", marginTop: "5px" }} />,
                        <img key="3" src={'./game5/studLive.png'} style={{ width: "76px", marginTop: "5px" }} />
                    ])
                        break;
                    case 1: setStudLive([
                        <img key="2" src={'./game5/studLive.png'} style={{ width: "76px", marginTop: "5px" }} />,
    ...
    return (
        <div style={{ width: "1920px", height: "1080px", backgroundColor: "white", zIndex: "1000", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
            <div>
                {question}
            </div>
            <div style={{ display: "flex" , height:"350px",}}>
                ...
                <div style={{position: "absolute", top: "720px", left: "50px" }}>
                    {profLive}
                </div>
                <div style={{position: "absolute", top: "720px", left: "1644px" }}>
                    {studLive}
                </div>
            </div>
            <div>
