            ...
            switch (replicants.studPointCounter) {
                ...
                case 1:
                    if (x != replicants.studPointCounter) {
                        ...
                        nodecg.Replicant('studOverallPoints').value += 1
                ...
                case 2:
                    if (x != replicants.studPointCounter) {
                        ...
                        nodecg.Replicant('studOverallPoints').value += 2
                        x = replicants.studPointCounter
                    }
                    break;
                case 3:
                    if (x != replicants.studPointCounter) {
                        ...
                        nodecg.Replicant('studOverallPoints').value += 3
                        x = replicants.studPointCounter
                    }
                    break;
                case 4:
                    if (x != replicants.studPointCounter) {
                        ...
                        nodecg.Replicant('studOverallPoints').value += 4
                        x = replicants.studPointCounter
                    }
                    break;
                case 5:
                    if (x != replicants.studPointCounter) {
                        ...
                        nodecg.Replicant('studOverallPoints').value += 5
                        x = replicants.studPointCounter
                    }
                    break;
                case 6:
                    if (x != replicants.studPointCounter) {
                        ...
                        nodecg.Replicant('studOverallPoints').value += 6
                        x = replicants.studPointCounter
                    }
                    break;
                case 7:
                    if (x != replicants.studPointCounter) {
                        ...
                        nodecg.Replicant('studOverallPoints').value += 7
                        x = replicants.studPointCounter
                    }
                    break;
                case 8:
                    if (x != replicants.studPointCounter) {
                        ...
                        nodecg.Replicant('studOverallPoints').value += 8
                        x = replicants.studPointCounter
                    }
                    break;
                case 9:
                    if (x != replicants.studPointCounter) {
                        ...
                        nodecg.Replicant('studOverallPoints').value += 9
                        x = replicants.studPointCounter
                    }
                    break;
            }
            ...
            switch (replicants.profPointCounter) {
                ...
                case 1:
                    if (y != replicants.profPointCounter) {
                        ...
                        nodecg.Replicant('profOverallPoints').value += 1
                ...
                case 2:
                    if (y != replicants.profPointCounter) {
                        ...
                        nodecg.Replicant('profOverallPoints').value += 2
                        y = replicants.profPointCounter
                    }
                    break;
                case 3:
                    if (y != replicants.profPointCounter) {
                        ...
                        nodecg.Replicant('profOverallPoints').value += 3
                        y = replicants.profPointCounter
                    }
                    break;
                case 4:
                    if (y != replicants.profPointCounter) {
                        ...
                        nodecg.Replicant('profOverallPoints').value += 4
                        y = replicants.profPointCounter
                    }
                    break;
                    case 5:
                ...
                case 7:
                    if (y != replicants.profPointCounter) {
                        ...
                        nodecg.Replicant('profOverallPoints').value += 7
                        y = replicants.profPointCounter
                    }
                    break;
                case 8:
                    if (y != replicants.profPointCounter) {
                        ...
                        nodecg.Replicant('profOverallPoints').value += 8
                        y = replicants.profPointCounter
                    }
                    break;
                case 9:
                    if (y != replicants.profPointCounter) {
                        ...
                        nodecg.Replicant('profOverallPoints').value += 9
                        y = replicants.profPointCounter
                    }
                    break;
            }
