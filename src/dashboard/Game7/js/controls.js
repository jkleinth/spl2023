  ...
  return (
    <div>
      ...
      <div className='solutions'>
        <button className='button' onClick={() => nodecg.Replicant('ordnungSolution').value = 1}>Freitag ist Wochenende</button>
        <button className='button' onClick={() => nodecg.Replicant('ordnungSolution').value = 2}>Hals- & Beinbruch</button>
        <button className='button' onClick={() => nodecg.Replicant('ordnungSolution').value = 3}>Korruptionskaraoke</button>
        <button className='button' onClick={() => nodecg.Replicant('ordnungSolution').value = 4}>Wosten</button>
        <button className='button' onClick={() => nodecg.Replicant('ordnungSolution').value = 5}>tierisch wild</button>
        <button className='button' onClick={() => nodecg.Replicant('ordnungSolution').value = 6}>PICNIC</button>
      </div>
      <div>Stud</div>
